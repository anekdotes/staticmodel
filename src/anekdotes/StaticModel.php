...
class StaticModel implements ArrayAccess
{
  ...
  public function getAttribute($key) {
    ...
    else if (array_key_exists(T::getLocale(), $this->instaceData) &&
   ...
   * @return boolean          if there's either a value or a translated value at that offset
   */
